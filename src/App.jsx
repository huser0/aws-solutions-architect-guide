  ...
  return (
    <div className="app-layout">
      <header className="app-header">
        ...
        <button onClick={goToIndex} style={{background:'none',border:'none',cursor:'pointer',display:'flex',alignItems:'center',gap:'8px'}}>
  ...
  return (
    <div className="welcome">
      ...
      <div className="stats-bar">
        ...
        <div><div className="stat-val">SAA-C03</div><div className="stat-lbl">Exame alvo</div></div>
        <div><div className="stat-val">☁</div><div className="stat-lbl">Multi-serviço</div></div>
      </div>
